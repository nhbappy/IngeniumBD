            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <center>
	                ...
	                <table class="table table-striped" style="max-width: 50%">
	                	<tr>
			                <td colspan="2">
			                    <center><img src="{{ asset('uploads/works/'.$data->id.'.jpg') }}" height="150" width="150" /></center>
			                </td>
	                	</tr>
	                	...
	                	<tr>
	                		<th><lable><font size="2">Details</font></lable></th>
	                		<td>: &nbsp;<font size="2">{{ $data->details}}</font></td>
	                	</tr>
	                	<tr>
	                		<th><lable><font size="2">Link</font></lable></th>
	                		<td>: &nbsp;<font size="2">{{ $data->link}}</font></td>
	                	</tr>
	                	<tr>
