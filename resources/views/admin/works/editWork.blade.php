    ...
    <body>
        <div id="wrapper" class="Index">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <h2>Create Work</h2>
                <hr />
                <form class="m-t" method="post" action="{{ url('/admin/trytoupdatework') }}" enctype="multipart/form-data">
                	...
                	<div class="form-horizontal">
				        ...
				        <div class="form-group">
				        	...
				        	<div class="col-md-10">
				            	<input class="form-control" type="text" id="details" name="details" value="{{ $data->details }}" required="" maxlength="150" placeholder="Details">
				            </div>
				        </div>
				        <div class="form-group">
				        	<div class="col-md-10" align="left"><label>Link</label></div>
				            <div class="col-md-10">
				            	<input class="form-control" type="text" id="link" name="link" value="{{ $data->link }}" required="" placeholder="Link">
				            </div>
				        </div>
				        <div class="form-group">
