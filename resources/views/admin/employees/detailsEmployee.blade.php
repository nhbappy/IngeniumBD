            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <center>
	                ...
	                <table class="table table-striped" style="max-width: 50%">
	                	<tr>
			                <td colspan="2">
			                    <center><img src="{{ asset('uploads/employees/'.$data->nid.'.jpg') }}" height="150" width="150" /></center>
			                </td>
	                	</tr>
	                	<tr><td colspan="2"><hr></td></tr>
	                	<tr>
	                		<th><lable><font size="2">Serial</font></lable></th>
	                		<td>: &nbsp;<font size="2">{{ $data->serial}}</font></td>
	                	</tr>
	                	<tr>
	                	...
	                	<tr>
	                		<th><lable><font size="2">Address</font></lable></th>
	                		<td>: &nbsp;<font size="2">{{ $data->address}}</font></td>
	                	</tr>
	                	<tr>
	                		<th><lable><font size="2">NID</font></lable></th>
	                		<td>: &nbsp;<font size="2">{{ $data->nid}}</font></td>
	                	</tr>
	                	<tr>
